...
import com.nokia.oss.outage.core.concurrency.ConcurrencyVisitor;
...
{
    private static final Logger LOG = LoggerFactory.getLogger( ConcurrencyRule.class );
    @Autowired
    ...
    {
        LOG.debug( "Check Concurrency ......" );
        ConcurrencyVisitor visitor = new ConcurrencyVisitor( riskTypes );
